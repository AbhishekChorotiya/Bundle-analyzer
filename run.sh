...
#   ./run.sh --pr feat/my-feature         # specific PR branch vs main
#   ./run.sh --base develop --pr feat/x   # specific base + PR
#   ./run.sh --force-build                # always rebuild (no cache)
#
